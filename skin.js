...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._container_5.appendChild(me.__33);
		...
		me._container_6.appendChild(me.__32);
		...
		me.__31.appendChild(me._container_3);
		...
		me.__26.appendChild(me._rectangle_1_1);
		...
		me.__22.logicBlock_alpha = function() {
			...
			if (me.__22.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me.__22.style.transition='opacity 500ms ease-in-out 0ms';
		...
		me.__25.appendChild(me._rectangle_3_1);
		...
		me.__24.appendChild(me._rectangle_3_2);
		...
		me.__23.appendChild(me._rectangle_3_3);
		...
		me._rectangle_3.appendChild(me.__21);
		...
		me.__19.appendChild(me._container_12);
		...
		me.__14.logicBlock_position = function() {
			...
			if (me.__14.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__14.style.transition='left 0s, top 0s, width 0s, height 0s';
				if (me.__14.ggCurrentLogicStatePosition == 0) {
					me.__14.style.left = 'calc(50% - (100% / 2))';
					me.__14.style.top='70px';
				}
				else {
					me.__14.style.left='calc(50% - ((100% + 0px) / 2) + 0px)';
					me.__14.style.top='60px';
				}
			}
		}
		...
		me.__14.logicBlock_size = function() {
			...
			if (me.__14.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__14.ggCurrentLogicStateSize == 0) {
					me.__14.style.width='40%';
					me.__14.style.height='80%';
					me.__14.style.left = 'calc(50% - (40% / 2))';
					skin.updateSize(me.__14);
				}
				else if (me.__14.ggCurrentLogicStateSize == 1) {
					me.__14.style.width='50%';
					me.__14.style.height='80%';
					me.__14.style.left = 'calc(50% - (50% / 2))';
					skin.updateSize(me.__14);
				}
				else if (me.__14.ggCurrentLogicStateSize == 2) {
					me.__14.style.width='60%';
					me.__14.style.height='80%';
					me.__14.style.left = 'calc(50% - (60% / 2))';
					skin.updateSize(me.__14);
				}
				else if (me.__14.ggCurrentLogicStateSize == 3) {
					me.__14.style.width='70%';
					me.__14.style.height='80%';
					me.__14.style.left = 'calc(50% - (70% / 2))';
					skin.updateSize(me.__14);
				}
				else if (me.__14.ggCurrentLogicStateSize == 4) {
					me.__14.style.width='80%';
					me.__14.style.height='84%';
					me.__14.style.left = 'calc(50% - (80% / 2))';
					skin.updateSize(me.__14);
				}
				else {
					me.__14.style.width='100%';
					me.__14.style.height='88%';
					me.__14.style.left = 'calc(50% - (100% / 2))';
					skin.updateSize(me.__14);
				}
			}
		...
		me.__18.appendChild(me._scrollarea_1);
		...
		me.__17.appendChild(me._svg_2_2);
		...
		me.__16.appendChild(me._container_11);
		...
		me.__9.logicBlock_position = function() {
			...
			if (me.__9.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__9.ggCurrentLogicStatePosition == 0) {
					...
					me.__9.style.top='70px';
				}
				else {
					me.__9.style.left='calc(50% - ((100% + 0px) / 2) + 0px)';
					me.__9.style.top='60px';
				}
			}
		}
		...
		me.__9.logicBlock_size = function() {
			...
			if (me.__9.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__9.ggCurrentLogicStateSize == 0) {
					me.__9.style.width='40%';
					me.__9.style.height='80%';
					me.__9.style.left = 'calc(50% - (40% / 2))';
					skin.updateSize(me.__9);
				}
				else if (me.__9.ggCurrentLogicStateSize == 1) {
					me.__9.style.width='50%';
					me.__9.style.height='80%';
					me.__9.style.left = 'calc(50% - (50% / 2))';
					skin.updateSize(me.__9);
				}
				else if (me.__9.ggCurrentLogicStateSize == 2) {
					me.__9.style.width='60%';
					me.__9.style.height='80%';
					me.__9.style.left = 'calc(50% - (60% / 2))';
					skin.updateSize(me.__9);
				}
				else if (me.__9.ggCurrentLogicStateSize == 3) {
					me.__9.style.width='70%';
					me.__9.style.height='80%';
					me.__9.style.left = 'calc(50% - (70% / 2))';
					skin.updateSize(me.__9);
				}
				else if (me.__9.ggCurrentLogicStateSize == 4) {
					me.__9.style.width='80%';
					me.__9.style.height='84%';
					me.__9.style.left = 'calc(50% - (80% / 2))';
					skin.updateSize(me.__9);
				}
				else {
		...
		me.__13.appendChild(me._svg_1_2);
		...
		me.__12.appendChild(me._container_10);
		...
		me.__11.appendChild(me._text_4);
		me._iframe0.appendChild(me.__11);
		me.__10.appendChild(me._iframe0);
		...
		me.__8.appendChild(me._svg_7_2);
		...
		me.__7.appendChild(me._container_1);
		...
		me._iframe.appendChild(me.__6);
		me.__5.appendChild(me._iframe);
		...
		me.__2.appendChild(me._svg_5_1);
		me._rectangle_4.appendChild(me.__2);
	...
	function SkinHotspotClass__(parentScope,hotspot) {
		...
		hs ='';
		hs+='height : 68.4211%;';
		hs+='left : calc(50% - ((72% + 0px) / 2) + 2px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((68.4211% + 0px) / 2) + 1px);';
		hs+='visibility : inherit;';
		hs+='width : 72%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._timer_31_1.ggActivate=function () {
			var flag=me.__0.ggScaleActive;
			if (player.transitionsDisabled) {
				me.__0.style.transition='none';
			} else {
				me.__0.style.transition='all 500ms linear 0ms';
			}
			if (flag) {
				me.__0.ggParameter.sx=1;me.__0.ggParameter.sy=1;
			} else {
				me.__0.ggParameter.sx=1.3;me.__0.ggParameter.sy=1.3;
			}
			me.__0.ggScaleActive=!flag;
				me.__0.style.transform=parameterToTransform(me.__0.ggParameter);
			setTimeout(function() {skin.updateSize(me.__0);}, 550);
		}
